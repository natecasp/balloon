...
var distAngle = ((diameter-pTailOd)/2) / (atan(params.distConeAng *(Math.PI/180)));
var proxAngle = ((diameter-pTailOd)/2) / (atan(params.proxConeAng *(Math.PI/180)));
...
var distAngle = ((Number($("#diameter-range").val())-Number($("#distalid-range").val()))/2) / (atan(Number($("#distalcone-range").val()) *(Math.PI/180)));
var proxAngle = ((Number($("#diameter-range").val())-Number($("#proximalid-range").val()))/2) / (atan(Number($("#proximalcone-range").val()) *(Math.PI/180)));
  console.log('distal cone length:' + distAngle);
