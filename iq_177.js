...
//START BALLOON VALIDATION
    ...
    function checkDistID(compliant, conversion){
      ...
      if($("#SUGGESTED-DIST-ID").is(":checked")) {
         if(compliant) {
           $("#DIST-ID-RANGE").val(Number($("#DIST-OD").val())-((DWT*4)*2)).trigger("input");
         } else {
          $("#DIST-ID-RANGE").val(Number($("#DIST-OD").val())-((DWT*2)*2)).trigger("input");
         }
      } else {
      if(compliant) {
    ...
    function checkProxID(compliant, conversion){
      ...
      if($("#SUGGESTED-PROX-ID").is(":checked")) {
         if(compliant) {
           $("#PROX-ID-RANGE").val(Number($("#PROX-OD").val())-((DWT*4)*2)).trigger("input");
         } else {
          $("#PROX-ID-RANGE").val(Number($("#PROX-OD").val())-((DWT*2)*2)).trigger("input");
         }
      } else {
      if(compliant) {
