...
//START BALLOON VALIDATION
    ...
    function checkLength(compliant){
      ...
      if (DIAMETER >= 1 && DIAMETER <= 8) {
        if(LEN >= 30 && LEN <= 170) { $("#LEN").removeClass('error'); $("#length-dialog").dialog("close");return true; } else { $("#LEN").addClass('error'); $("#length-dialog").dialog("open"); return false; }
      } else if (DIAMETER > 8 && DIAMETER <= 12.5) {
        if(LEN >= 24 && LEN <= 64) { $("#LEN").removeClass('error'); $("#length-dialog").dialog("close"); return true; } else { $("#LEN").addClass('error'); $("#length-dialog").dialog("open"); return false; }
      } else if (DIAMETER > 12.5 && DIAMETER <= 19) {
        if(LEN >= 20 && LEN <= 60) { $("#LEN").removeClass('error'); $("#length-dialog").dialog("close"); return true; } else { $("#LEN").addClass('error'); $("#length-dialog").dialog("open"); return false; }
    ...
    function checkDWT(compliant){
      ...
      if(compliant) {
        if(DWT >= 0.0015 && DWT <= 0.003) { $("#DWT").removeClass('error'); $("#dwt-dialog").dialog("close"); return true; } else { $("#DWT").addClass('error'); $("#dwt-dialog").dialog("open"); return false; }
      } else {
        if(DWT >= 0.0015 && DWT <= 0.003) { $("#DWT").removeClass('error'); $("#dwt-dialog").dialog("close"); return true; } else { $("#DWT").addClass('error'); $("#dwt-dialog").dialog("open"); return false; }
      }  
    }
