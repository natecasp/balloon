...
let g = new THREE.CylinderGeometry( diameter, diameter, len, 64, 15, true );
let distalCone = new THREE.CylinderGeometry( diameter, dTailOd, distAngle, 64, 1, true );
let distalTail = new THREE.CylinderGeometry( dTailOd, dTailOd, dTailLen, 64, 1, true );
let proximalCone = new THREE.CylinderGeometry( pTailOd, diameter, proxAngle, 64, 1, true );
let proximalTail = new THREE.CylinderGeometry( pTailOd, pTailOd, pTailLen, 64, 1, true );
...
curve.absarc(pTailOd, 0, (diameter-pTailOd), 0, Math.PI/2 );
var points = curve.getSpacedPoints( 20 );
const proxCurve = new THREE.LatheGeometry( points, 64 );
let dCurve = new THREE.Shape();
dCurve.absarc(dTailOd, 0, (diameter-dTailOd), (Math.PI*3)/2, 0 );
...
dTail.position.set(0,-((len/2)+(dTailLen/2)+(diameter-dTailOd)),0)
} else {
...
if(params.proxCurve === true){
  ...
  pTail.position.set(0,((len/2)+(pTailLen/2)+(diameter-pTailOd)),0)
} else{ 
...
lengthController.setValue(this.value.toFixed(1));
$("#LEN").val(this.value.toFixed(1));
});
$("#LEN").on('change', function() {
lengthController.setValue(this.value.toFixed(1));
$("#len-range").val(this.value.toFixed(1));
});
//DWT
$("#wall-range").on('input', function() {
$("#DWT").val(this.value.toFixed(2));
});
$("#DWT").on('change', function() {
$("#wall-range").val(this.value.toFixed(2));
});
//DIAMETER
$("#diameter-range").on('input', function() {
diameterController.setValue(Number(this.value).toFixed(2));
$("#DIAMETER").val(this.value.toFixed(2));
$("#distalid-range,#DIST-ID,#proximalid-range,#PROX-ID").attr({"min": this.value/15, "max": this.value});
if($("#distalid-range").val() < this.value/15) { $("#distalid-range,#DIST-ID").val(this.value/15.toFixed(3)); distalTailOdController.setValue(Number(this.value/15).toFixed(3));$("#DIAMETER,#diameter-range").attr("min", Number(this.value/15)); }
if($("#proximalid-range").val() < this.value/15) { $("#proximalid-range,#PROX-ID").val(this.value/15.toFixed(3)); proximalTailOdController.setValue(Number(this.value/15).toFixed(3));$("#DIAMETER,#diameter-range").attr("min", Number(this.value/15)); }

});
$("#DIAMETER").on('change', function() {
diameterController.setValue(Number(this.value).toFixed(2));
$("#diameter-range").val(this.value.toFixed(2));
$("#distalid-range,#DIST-ID,#proximalid-range,#PROX-ID").attr({"min": this.value/15, "max": this.value});
if($("#distalid-range").val() < this.value/15) { $("#distalid-range,#DIST-ID").val(this.value/15.toFixed(3)); distalTailOdController.setValue(Number(this.value/15).toFixed(3));$("#DIAMETER,#diameter-range").attr("min", Number(this.value/15)); }
if($("#proximalid-range").val() < this.value/15) { $("#proximalid-range,#PROX-ID").val(this.value/15.toFixed(3)); proximalTailOdController.setValue(Number(this.value/15).toFixed(3));$("#DIAMETER,#diameter-range").attr("min", Number(this.value/15)); }
});
...
$("#DIST-ID").val(this.value.toFixed(3));
var pid = $("#proximalid-range").val();
$("#diameter-range,#DIAMETER").attr("min", Math.max(this.value, pid));
if(Number(this.value) > Number($("#diameter-range").val())) { console.log('distal OD is greater than diameter');diameterController.setValue(this.value.toFixed(2));$("#diameter-range,#DIAMETER").val(this.value.toFixed(2));}
});
$("#DIST-ID").on('change', function() {
distalTailOdController.setValue(Number(this.value).toFixed(3));
$("#distalid-range").val(this.value.toFixed(3));
var pid = $("#proximalid-range").val();
$("#diameter-range,#DIAMETER").attr("min", Math.max(this.value, pid));
if(Number(this.value) > Number($("#diameter-range").val())) { console.log('distal OD is greater than diameter');diameterController.setValue(this.value.toFixed(2));$("#diameter-range,#DIAMETER").val(this.value.toFixed(2));}
});
...
$("#PROX-ID").val(this.value.toFixed(3));
...
if(Number(this.value) > Number($("#diameter-range").val())) {diameterController.setValue(this.value.toFixed(2));$("#diameter-range,#DIAMETER").val(this.value.toFixed(2));}
});
$("#PROX-ID").on('change', function() {
proximalTailOdController.setValue(Number(this.value).toFixed(3));
$("#proximalid-range").val(this.value.toFixed(3));
var did = $("#distalid-range").val();
$("#diameter-range,#DIAMETER").attr("min", Math.max(this.value, did));
if(Number(this.value) > Number($("#diameter-range").val())) {diameterController.setValue(this.value.toFixed(2));$("#diameter-range,#DIAMETER").val(this.value.toFixed(2));}
});
...
distalTailLenController.setValue(this.value.toFixed(1));
$("#DIST-NECK").val(this.value.toFixed(1));
});
$("#DIST-NECK").on('change', function() {
distalTailLenController.setValue(this.value.toFixed(1));
$("#distalneck-range").val(this.value.toFixed(1));
});
//P NECK
$("#proximalneck-range").on('input', function() {
proximalTailLenController.setValue(this.value.toFixed(1));
$("#PROX-NECK").val(this.value.toFixed(1));
});
$("#PROX-NECK").on('change', function() {
proximalTailLenController.setValue(this.value.toFixed(1));
$("#proximalneck-range").val(this.value.toFixed(1));
});
...
var distAngle = Number(((($("#diameter-range").val())/2)*Math.tan((90-$("#distalcone-range").val()) * Math.PI/180)));
var proxAngle = Number(((($("#diameter-range").val())/2)*Math.tan((90-$("#proximalcone-range").val()) * Math.PI/180)));
if((Number($("#len-range").val())+distAngle+proxAngle) > maxLength) {
var newBody = Math.max((maxLength - distAngle - proxAngle), 0);
