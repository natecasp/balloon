...
if($("#distalid-range").val() < this.value/15) { $("#distalid-range,#DIST-ID").val(this.value/15); distalTailOdController.setValue(Number(this.value/15));$("#DIAMETER,#diameter-range").attr("min", Number(this.value/15)); }
if($("#proximalid-range").val() < this.value/15) { $("#proximalid-range,#PROX-ID").val(this.value/15); proximalTailOdController.setValue(Number(this.value/15));$("#DIAMETER,#diameter-range").attr("min", Number(this.value/15)); }
...
if(Number(this.value) > Number($("#diameter-range").val())) { console.log('distal OD is greater than diameter');diameterController.setValue(this.value);$("#diameter-range,#DIAMETER").val(this.value);}
});
...
if(Number(this.value) > Number($("#diameter-range").val())) {diameterController.setValue(this.value);$("#diameter-range,#DIAMETER").val(this.value);}
});
