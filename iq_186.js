...
function preventImpossible() {
  ...
  if (Number($("#DIST-ID").val()) < (.4*conversion)) {
    $("#DIST-ID, #DIST-ID-RANGE").val((.38*conversion).toFixed(3));
    return false;
  }
  if (Number($("#PROX-ID").val())  < (.4*conversion)) {
    $("#PROX-ID, #PROX-ID-RANGE").val((.38*conversion).toFixed(3));
    return false;
  }
  if($("#SUGGESTED-DIST-ID").is(":checked")) {
     if((Number($("#DIST-OD").val())-((Number($("#DWT").val())*4)*2)) < (0.4*conversion)) {
       $("#DIST-OD,#DIST-OD-RANGE").val(((0.38*conversion)+((Number($("#DWT").val())*4)*2)).toFixed(3))
       return false;
     }
  }
  if($("#SUGGESTED-PROX-ID").is(":checked")) {
     if((Number($("#PROX-OD").val())-((Number($("#DWT").val())*4)*2)) < (0.4*conversion)) {
       $("#PROX-OD,#PROX-OD-RANGE").val(((0.38*conversion)+((Number($("#DWT").val())*4)*2)).toFixed(3))
       return false;
     }
  }
