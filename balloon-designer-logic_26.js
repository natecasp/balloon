...
var distAngle = Number(((($("#diameter-range").val()-$("#distalid-range").val())/2)*Math.tan((90-$("#distalcone-range").val()) * Math.PI/180)));
var proxAngle = Number(((($("#diameter-range").val()-$("#proximalid-range").val())/2)*Math.tan((90-$("#proximalcone-range").val()) * Math.PI/180)));
