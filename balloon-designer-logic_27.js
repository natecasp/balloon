...
var distAngle = ((diameter-dTailOd)/2)*Math.sin((90-params.distConeAng)* (Math.PI/180)) / Math.sin((params.distConeAng)* (Math.PI/180));
var proxAngle = ((diameter-pTailOd)/2)*Math.sin((90-params.proxConeAng)* (Math.PI/180)) / Math.sin((params.proxConeAng)* (Math.PI/180));
...
if($("#distalid-range").val() < this.value/15) { $("#distalid-range,#DIST-ID").val(Number(this.value/15).toFixed(3)); distalTailOdController.setValue(Number(this.value/15).toFixed(3));$("#DIAMETER,#diameter-range").attr("min", Number(this.value/15)); }
if($("#proximalid-range").val() < this.value/15) { $("#proximalid-range,#PROX-ID").val(Number(this.value/15).toFixed(3)); proximalTailOdController.setValue(Number(this.value/15).toFixed(3));$("#DIAMETER,#diameter-range").attr("min", Number(this.value/15)); }
...
var distAngle = (($("#diameter-range").val()-$("#distalid-range").val())/2)*Math.sin((90-$("#distalcone-range").val())* (Math.PI/180)) / Math.sin(($("#distalcone-range").val())* (Math.PI/180));
var proxAngle = (($("#diameter-range").val()-$("#proximalid-range").val())/2)*Math.sin((90-$("#proximalcone-range").val())* (Math.PI/180)) / Math.sin(($("#proximalcone-range").val())* (Math.PI/180));
