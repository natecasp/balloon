...
//START BALLOON VALIDATION
    ...
    function checkDistNeck(compliant){
      ...
      if(compliant) {
        if(DIST_NECK >= 2 && DIST_NECK <= 25) { $("#DIST-NECK").removeClass('error'); return true; $("#dist-neck-dialog").dialog("close");} else { $("#DIST-NECK").addClass('error'); return false; $("#dist-neck-dialog").dialog("open");}
      } else {
        if(DIST_NECK >= 2 && DIST_NECK <= 25) { $("#DIST-NECK").removeClass('error'); return true; $("#dist-neck-dialog").dialog("close");} else { $("#DIST-NECK").addClass('error'); return false; $("#dist-neck-dialog").dialog("open");}
      }
    }
    function checkProxNeck(compliant){
      ...
      if(compliant) {
        if(PROX_NECK >= 2 && PROX_NECK <= 25) { $("#PROX-NECK").removeClass('error'); return true; $("#prox-neck-dialog").dialog("close");} else { $("#PROX-NECK").addClass('error'); return false; $("#prox-neck-dialog").dialog("open");}
      } else {
        if(PROX_NECK >= 2 && PROX_NECK <= 25) { $("#PROX-NECK").removeClass('error'); return true; $("#prox-neck-dialog").dialog("close");} else { $("#PROX-NECK").addClass('error'); return false; $("#prox-neck-dialog").dialog("open");}
      }  
    }
    ...
    function checkLength(compliant){
      ...
      if (DIAMETER >= 1 && DIAMETER <= 8) {
        if(LEN >= 30 && LEN <= 170) { $("#LEN").removeClass('error'); return true; $("#length-dialog").dialog("close");} else { $("#LEN").addClass('error'); return false; $("#length-dialog").dialog("open");}
      } else if (DIAMETER > 8 && DIAMETER <= 12.5) {
        if(LEN >= 24 && LEN <= 64) { $("#LEN").removeClass('error'); return true; $("#length-dialog").dialog("close");} else { $("#LEN").addClass('error'); return false; $("#length-dialog").dialog("open");}
      } else if (DIAMETER > 12.5 && DIAMETER <= 19) {
        if(LEN >= 20 && LEN <= 60) { $("#LEN").removeClass('error'); return true; $("#length-dialog").dialog("close");} else { $("#LEN").addClass('error'); return false; $("#length-dialog").dialog("open");}
    ...
    function checkDiameter(compliant){
      var DIAMETER = Number($("#DIAMETER").val());
      if(compliant) {
        if(DIAMETER >= 1 && DIAMETER <= 33) { $("#DIAMETER").removeClass('error'); return true; $("#diameter-dialog").dialog("close");} else { $("#DIAMETER").addClass('error'); return false; $("#diameter-dialog").dialog("open");}
      } else {
        if(DIAMETER >= 1 && DIAMETER <= 33) { $("#DIAMETER").removeClass('error'); return true; $("#diameter-dialog").dialog("close");} else { $("#DIAMETER").addClass('error'); return false; $("#diameter-dialog").dialog("open");}
      }  
    }
    ...
    function checkDWT(compliant){
      ...
      if(compliant) {
        if(DWT >= 0.0015 && DWT <= 0.003) { $("#DWT").removeClass('error'); return true; $("#dwt-dialog").dialog("close");} else { $("#DWT").addClass('error'); return false; $("#dwt-dialog").dialog("open");}
      } else {
        if(DWT >= 0.0015 && DWT <= 0.003) { $("#DWT").removeClass('error'); return true; $("#dwt-dialog").dialog("close");} else { $("#DWT").addClass('error'); return false; $("#dwt-dialog").dialog("open");}
      }  
    }
    ...
    function checkDistOd(compliant){
      ...
      // if(compliant) {
      //   if(DIST_OD >= 0.0015 && DIST_OD <= 0.003) { $("#DIST-OD").removeClass('error'); return true; $("#dist-od-dialog").dialog("close");} else { $("#DIST-OD").addClass('error'); return false; $("#dist-od-dialog").dialog("open");}
      // } else {
      //   if(DIST_OD >= 0.008 && DIST_OD <= 0.01) { $("#DIST-OD").removeClass('error'); return true; $("#dist-od-dialog").dialog("close");} else { $("#DIST-OD").addClass('error'); return false; $("#dist-od-dialog").dialog("open");}
      // }  
      return true;
    }
	...
	if (!$("#DIST-CURVE").is(":checked")) {
		...
		if(DIST_CONE >= 20 && DIST_CONE <= 90 ) { $("#DIST-CONE").removeClass('error'); return true; $("#dist-cone-dialog").dialog("close");} else { $("#DIST-CONE").addClass('error'); return false; $("#dist-cone-dialog").dialog("open");}
	} else {
		return true;
	}
    ...
    function checkProxCone(compliant){
      if (!$("#PROX-CURVE").is(":checked")) {
		...
		if(PROX_CONE >= 20 && PROX_CONE <= 90 ) { $("#PROX-CONE").removeClass('error'); return true; $("#prox-cone-dialog").dialog("close");} else { $("#PROX-CONE").addClass('error'); return false; $("#prox-cone-dialog").dialog("open");}
	} else {
		return true;
	}
    }
