...
var distAngle = ((Number($("#diameter-range").val())-Number($("#distalid-range").val()))/2) * Math.sin(90 - (Number($("#distalcone-range").val()) *(Math.PI/180))) / Math.sin(Number($("#distalcone-range").val()) *(Math.PI/180));
var proxAngle = ((Number($("#diameter-range").val())-Number($("#proximalid-range").val()))/2) * Math.sin(90 - (Number($("#proximalcone-range").val()) *(Math.PI/180))) / Math.sin(Number($("#proximalcone-range").val()) *(Math.PI/180));
