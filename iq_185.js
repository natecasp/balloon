...
function preventImpossible() {
  ...
  if($("#SUGGESTED-DIST-ID").is(":checked")) {
     if((Number($("#DIST-OD").val())-((Number($("#DWT").val())*4)*2)) < (0.38*conversion)) {
       $("#DIST-OD,#DIST-OD-RANGE").val((0.38*conversion)+((Number($("#DWT").val())*4)*2))
       return false;
     }
  }
  if($("#SUGGESTED-PROX-ID").is(":checked")) {
     if((Number($("#PROX-OD").val())-((Number($("#DWT").val())*4)*2)) < (0.38*conversion)) {
       $("#PROX-OD,#PROX-OD-RANGE").val((0.38*conversion)+((Number($("#DWT").val())*4)*2))
       return false;
     }
  }
