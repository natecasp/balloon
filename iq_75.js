...
const export = gui.addFolder( 'Export' );
const imageController = export.add( params, 'takeScreenshot').name('Save as Image');
const stlController = export.add( params, 'exportBinary').name('Save as STL');
