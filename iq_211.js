...
function checkLength(compliant, conversion){
  ...
  if(LEN >= 0 && LEN <= maxLength) {
    ...
    if(LEN > maxLength) {
      addError(
        'length-too-long',
        'Length is too large at this diameter for an instant quote',
        'Decrease length parameters, or adjust diameter',
        null,
        '#LEN'
      );
    }
