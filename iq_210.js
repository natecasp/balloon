  ...
  if(compliant) {
    if(DIST_NECK_TOL == 'min') {
      ...
      addError(
        ...
        'Distal neck tolerance must be MIN',
  ...
  if(compliant) {
    if(PROX_NECK_TOL == 'min') {
      ...
      addError(
        ...
        'Proximal neck tolerance must be MIN',
        'Set tolerance to MIN',
        null,
        '#PROX-NECK-TOL'
      );
...
function checkLength(compliant, conversion){
  ...
  if(LEN >= 0 && LEN <= maxLength) {
    ...
    if(LEN > maxLength) {
      addError(
        'length-too-long',
        'Total length exceeds maximum for this diameter',
        'Decrease length parameters',
        null,
        '#LEN'
      );
    }
  ...
  if(compliant) {
    if(DIAMETER >= (1*conversion) && DIAMETER <= (33*conversion)) {
      ...
      addError(
        ...
        'Diameter is outside acceptable range',
        'Adjust diameter to be within range',
        null,
        '#DIAMETER'
      );
      return false;
  ...
  if(compliant) {
    if(DIAMETER_TOL.toLowerCase() == 'min') {
      ...
      addError(
        ...
        'Diameter tolerance must be MIN for compliant materials',
    ...
    if(Number(DIAMETER_TOL) >= (0.5*conversion)) {
      ...
      addError(
        'diameter-tol-small',
        'Diameter tolerance is too small',
...
function checkDWT(compliant, conversion){
  ...
  if(compliant) {
    if(DWT >= (0.05*conversion) && DWT <= (0.38*conversion)) {
      ...
      addError(
        'dwt-out-of-range',
        'DWT is outside acceptable range for compliant materials',
        'Adjust DWT to be within range',
        null,
        '#DWT'
      );
      return false;
    ...
    if(DWT >= (0.05*conversion) && DWT <= (0.25*conversion)) {
      ...
      addError(
        'dwt-out-of-range',
        'DWT is outside acceptable range',
        'Adjust DWT to be within range',
        null,
        '#DWT'
      );
...
function checkDistOdTol(compliant, conversion){
  ...
  if(compliant) {
    if(DIST_OD_TOL >= (0.075*conversion)) {
      ...
      addError(
        'dist-od-tol-small',
        'Distal OD tolerance is too small',
...
function checkProxOdTol(compliant, conversion){
  ...
  if(compliant) {
    if(PROX_OD_TOL >= (0.075*conversion)) {
      ...
      addError(
        'prox-od-tol-small',
        'Proximal OD tolerance is too small',
...
function checkDistID(compliant, conversion){
  ...
  if(compliant) {
    if(DIST_WT <= (DWT*10)) {
      ...
      addError(
        'dist-id-wall-thick',
        'Distal wall thickness exceeds allowable limit',
...
function checkDistIDTol(compliant, conversion){
  ...
  if(compliant) {
    if(DIST_ID_TOL >= (0.025*conversion)) {
      ...
      addError(
        'dist-id-tol-small',
        'Distal ID tolerance is too small',
...
function checkProxID(compliant, conversion){
  ...
  if(compliant) {
    if(PROX_WT <= (DWT*10)) {
      ...
      addError(
        'prox-id-wall-thick',
        'Proximal wall thickness exceeds allowable limit',
...
function checkProxIDTol(compliant, conversion){
  ...
  if(compliant) {
    if(PROX_ID_TOL >= (0.025*conversion)) {
      ...
      addError(
        'prox-id-tol-small',
        'Proximal ID tolerance is too small',
  ...
  if (!$("#DIST-CURVE").is(":checked")) {
    ...
    if(DIST_CONE >= 20 && DIST_CONE <= 90) {
      ...
      addError(
        ...
        'Distal cone angle is outside acceptable range',
        'Set angle between 20 and 90 degrees',
        null,
        '#DIST-CONE'
      );
      return false;
...
function checkDistConeTol(compliant, conversion){
  if (!$("#DIST-CURVE").is(":checked")) {
    ...
    if(DIST_CONE_TOL >= 3) {
      ...
      addError(
        'dist-cone-tol-small',
        'Distal cone tolerance is too small',
        'Increase cone tolerance to at least 3',
        null,
        '#DIST-CONE-TOL'
      );
      return false;
  ...
  if (!$("#PROX-CURVE").is(":checked")) {
    ...
    if(PROX_CONE >= 20 && PROX_CONE <= 90) {
      ...
      addError(
        ...
        'Proximal cone angle is outside acceptable range',
        'Set angle between 20 and 90 degrees',
        null,
        '#PROX-CONE'
      );
...
function checkProxConeTol(compliant, conversion){
  if (!$("#PROX-CURVE").is(":checked")) {
    ...
    if(PROX_CONE_TOL >= 3) {
      ...
      addError(
        'prox-cone-tol-small',
        'Proximal cone tolerance is too small',
        'Increase cone tolerance to at least 3',
        null,
        '#PROX-CONE-TOL'
      );
...
function checkHoop(compliant) {
  ...
  if (distHoop > maxHoop) {
    addError(
        ...
        'Distal hoop ratio exceeds maximum allowable',
  ...
  if (proxHoop > maxHoop) {
    addError(
        ...
        'Proximal hoop ratio exceeds maximum allowable',
...
function checkFatigue(compliant) {
  if(compliant) {
    ...
    if(Number($("#REQUESTED-FATIGUE").val()) > 10) {
      addError(
        'fatigue-too-high',
        'Requested fatigue value exceeds maximum',
        'Reduce fatigue value to 10 or less',
        null,
        '#REQUESTED-FATIGUE'
      );
      return false;
