...
if(['Vestamid ML21','PET','Pebax 55D', 'Pebax 63D', 'Pebax 72D'].includes($("#MATERIAL").val())) {
  ...
  $("#l"+ line + "-REQUESTED-VOLUME").closest('p').text('Requested Burst');
  $("#l"+ line + "-REQUESTED-MIN-VOLUME").closest('p').text('Requested Burst');
  ...
  $("#l"+ line + "-REQUESTED-BURST").closest('p').text('Requested Nominal Vol');
  $("#l"+ line + "-REQUESTED-FATIGUE").closest('p').text('Requested Min Burst Vol');
