...
function changeThickness( WT ) {
   if($("#SUGGESTED-DIST-ID").is(":checked")) {
         if(compliant) {
           $("#DIST-ID-RANGE").val(Number($("#DIST-OD").val())-((DWT*4)*2));
           var distTailWT = DWT*4;
         } else {
          $("#DIST-ID-RANGE").val(Number($("#DIST-OD").val())-((DWT*2)*2));
           var distTailWT = DWT*2;
         }
      } else {
     ...
     if($("#SUGGESTED-PROX-ID").is(":checked")) {
         if(compliant) {
           $("#PROX-ID-RANGE").val(Number($("#PROX-OD").val())-((DWT*4)*2));
           var proxTailWT = DWT*4;
         } else {
          $("#PROX-ID-RANGE").val(Number($("#PROX-OD").val())-((DWT*2)*2));
           var proxTailWT = DWT*2;
         }
      } else {
