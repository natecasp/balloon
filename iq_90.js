...
function preventImpossible() {
  if (Number($("#DIAMETER").val()) < Math.min(Number($("#DIST-OD").val()), proxTailOd: Number($("#PROX-OD").val())) + 1) { 
    $("#DIAMETER").val(Math.min(Number($("#DIST-OD").val()), proxTailOd: Number($("#PROX-OD").val())) + 1); 
    return false; 
  }
