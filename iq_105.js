...
if(compliant) {
  ...
  var proxID = Number($("#PROX-OD").val()) - (Number($("#PROX-WT").val())*2);
  var extrusionID = Math.min(distID, proxID);
  var maxBurst = (extrusionID*-2.6656) + 27;
  console.log(maxBurst);
  if(Number($("#REQUESTED-BURST").val()) > maxBurst) {
...
if($("#QUANTITY").val() == 'More') {
  ...
  $(".compliant-burst").css('display', 'none'); 
    ...
    if(f1 && f2 && f3 && f4 && f5 && f6 && f7 && f8 && f9 && f10 && f11 && f12 && f13 && f14 && f15 && f16 && f17 && f18 && f19 && f20 && f21 && f22 & f23 & f24) 
	{
