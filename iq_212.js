  ...
  if(LEN >= 0 && LEN <= maxLength) {
    ...
    if(LEN > maxLength) {
      addError(
        ...
        'Decrease length, increase cone angles, or adjust diameter',
        null,
        '#LEN'
      );
    }
  ...
  if(compliant) {
    if(PROX_OD_TOL >= (0.075*conversion)) {
      ...
      addError(
        ...
        'Increase proximal OD tolerance',
        null,
        '#PROX-OD-TOL'
      );
      return false;
  ...
  if(compliant) {
    if(PROX_WT <= (DWT*10)) {
      ...
      addError(
        ...
        'Adjust proximal ID or OD values',
        null,
        '#PROX-ID'
      );
      return false;
  ...
  if(compliant) {
    if(PROX_ID_TOL >= (0.025*conversion)) {
      ...
      addError(
        ...
        'Increase proximal ID tolerance',
        null,
        '#PROX-ID-TOL'
      );
      return false;
...
function checkHoop(compliant) {
  ...
  if (proxHoop > maxHoop) {
    addError(
        ...
        'Adjust diameter or proximal ID',
        null,
        '#PROX-ID'
      );
  } else {
