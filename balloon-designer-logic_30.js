...
var distAngle = ((Number($("#diameter-range").val())-Number($("#distalid-range").val()))/2) / (Math.atan(Number($("#distalcone-range").val()) *(Math.PI/180)));
var proxAngle = ((Number($("#diameter-range").val())-Number($("#proximalid-range").val()))/2) / (Math.atan(Number($("#proximalcone-range").val()) *(Math.PI/180)));
  console.log('distal cone length:' + distAngle);
