...
if(this.value > $("#diameter-range").val()) { console.log('distal OD is greater than diameter');diameterController.setValue(this.value);$("#diameter-range,#DIAMETER").val(this.value);}
});
