...
//START BALLOON VALIDATION
    ...
    function checkDiameterTol(compliant){
      ...
      if(complaint) {
        if(DIAMETER_TOL == 'MIN') { $("#DIAMETER-TOL").removeClass('error'); return true; } else { $("#DIAMETER-TOL").addClass('error'); return false; }
      } else {
        if(DIAMETER_TOL >= 0.5) { $("#DIAMETER-TOL").removeClass('error'); return true; } else { $("#DIAMETER-TOL").addClass('error'); return false; }
      }  
    }
